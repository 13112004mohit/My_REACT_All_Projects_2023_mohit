...
import {RiArrowRightSFill,RiTimeLine} from 'react-icons/ri'
import { RiInstagramFill } from 'react-icons/ri';
import {FaFacebookF,FaPhoneAlt,FaWhatsapp,  FaTwitter,FaInstagram,FaYoutube} from 'react-icons/fa'
           ...
           <div className="footer_m_con">
               ...
               <div className="footer_four_col_">
                  ...
                  <div className="footer_col4">
                     <h3>Quick Links</h3>
                        <NavLink onClick={()=>{ window.scrollTo({top:0 ,left:0 ,behavior:'auto'})}} to={'/collegetemplete'}><RiArrowRightSFill id='leftarrow_'/>HOME</NavLink>
                        <NavLink onClick={()=>{ window.scrollTo({top:0 ,left:0 ,behavior:'auto'})}} to={'/about'}><RiArrowRightSFill id='leftarrow_'/>ABOUT</NavLink>
                        <NavLink onClick={()=>{ window.scrollTo({top:0 ,left:0 ,behavior:'auto'})}} to={'/packages'}><RiArrowRightSFill id='leftarrow_'/>COURSES</NavLink>
                        <NavLink onClick={()=>{ window.scrollTo({top:0 ,left:0 ,behavior:'auto'})}} to={'/gallery'}><RiArrowRightSFill id='leftarrow_'/>GALLERY</NavLink>
                        <NavLink onClick={()=>{ window.scrollTo({top:0 ,left:0 ,behavior:'auto'})}} to={'/contact'}><RiArrowRightSFill id='leftarrow_'/>NOTICE</NavLink>
                  ...
                  <div className="footer_col4" >
                     <h3>Socal media</h3>
                        ...
                        <a href='tel:7007187764'><FaTwitter id='socalicon'/> Twitter</a>
                  ...
                  <div className="footer_col3">
                        ...
                        <div className="footer_col_3_F_">
                             ...
                             <div className="footer_col_3_F_data">
                               <a href="tel:+">+1 (444) 000-8888</a>
                               <a href="tel:+">+91 7052 101 786</a>
                             </div>
                        </div>   
                        <div className="footer_col_3_F_">
               ...
               <p id='copyright'>Copyright © 2020 Ancient Holy City Tour- All Rights Reserved.</p>
            </div>   
    </>
  )
}
