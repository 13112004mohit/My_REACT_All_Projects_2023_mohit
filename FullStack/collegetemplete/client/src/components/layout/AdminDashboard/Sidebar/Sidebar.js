...
const Sidebar = ({ setActive, active, isDrawerOpen, setIsDrawerOpen }) => {
  ...
  return (
    <>
      ...
      <p style={{left:'-1.2rem'}} className="seprator-line">admin dashboard  </p>
          {/* DASHBOARD BUTTON  ----------------------- */}
     ...
     <p style={{marginTop:'2rem',left:'-2rem'}} className="seprator-line">website pages </p>
     ...
     <p style={{marginTop:'2rem',left:'-1.2rem'}} className="seprator-line">view website page </p>
